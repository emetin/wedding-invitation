const ADMIN_WEDDING_SLUG = "sema-emre";
...
async function loadWeddingForAdmin() {
  try {
    ...
    console.log("Admin wedding slug:", ADMIN_WEDDING_SLUG);
    console.log("Admin wedding id:", adminWeddingId);
    console.log("Admin wedding data:", data);
...
async function loadMessages() {
  if (!adminWeddingId) {
    console.error("adminWeddingId yok. Mesajlar çekilemedi.");
    return;
  }
...
async function loadPhotos() {
  if (!adminWeddingId) {
    console.error("adminWeddingId yok. Fotoğraflar çekilemedi.");
    return;
  }
